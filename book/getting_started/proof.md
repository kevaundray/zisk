...
`ziskemu -i build/input.bin -x -e target/riscv64imac-unknown-none-elf/release/fibonacci`
...
```bash
ziskemu -i build/input.bin -x -e target/riscv64imac-unknown-none-elf/debug/fibonacci
```
