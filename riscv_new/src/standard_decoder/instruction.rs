...
pub enum Instruction {
    ...
    // === RV32M/RV64M Multiply Extension (R-type) ===
    ...
    // === RV32A/RV64A Atomic Extension (A-type) ===
...
impl Instruction {
    ...
    pub fn mnemonic(&self) -> &'static str {
        match self {
            ...
            // Memory ordering (Zifencei extension)
    ...
    /// Check if this is a NOP instruction (standard NOP only)
...
impl fmt::Display for Instruction {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            // Format instructions with their operands
