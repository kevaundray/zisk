...
#[no_mangle]
pub unsafe extern "C" fn bls12_381_g2_add_c(ret: *mut u8, a: *const u8, b: *const u8) -> u8 {
    ...
    if !is_on_curve_twist_bls12_381(&a_u64) || !is_on_curve_twist_bls12_381(&b_u64) {
        return 2;
    }

    // Perform addition
    let result = add_twist_bls12_381(&a_u64, &b_u64);
...
pub unsafe extern "C" fn bls12_381_g2_msm_c(
    ...
    for i in 0..num_pairs {
        ...
        if !is_on_curve_twist_bls12_381(&point_u64) {
            return 2;
        }
        ...
        // Compute P * k
        let product = scalar_mul_twist_bls12_381(&point_u64, &scalar_u64);
